...
public class SimpleGetObjectSample {
    ...
    private static String accessKeyId = "LTAI4FiNnh1nnNBKUYvnx3my";
    private static String accessKeySecret = "JcPI8WSglwWDFgLhXuPwqb8fRNZd5m";

    private static String bucketName = "201990904";
