...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "U2Cp7u7UEhUzHbVmwkfRjVZRNOb3USJNodyJQP3t";
    private static final String SECRET_KEY = "e9iKoci_M5i8smZ_I5PrSQ3WqcumvL0l-X0Rhl1V";

    // 要上传的空间
    private static final String bucketname = " 20190905";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "D:\\huawei\\screenshot";

    private static final String style = "wangqing";
